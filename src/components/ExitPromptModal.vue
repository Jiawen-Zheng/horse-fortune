  ...
  <div v-if="show" class="modal-overlay" @click="handleCancel">
    <div class="modal-content" @click.stop>
      ...
      <div class="modal-body">
        <div class="icon">👋</div>
        <h3 class="title">确定要离开吗？</h3>
        <p class="message">您还有剩余使用次数哦</p>
        ...
        <div class="shop-promo">
          <div class="shop-header">
            ...
            <span class="shop-title">发现更多精彩</span>
          </div>
      ...
      <div class="modal-footer">
        <button class="secondary-button" @click="handleConfirm">确定离开</button>
        <button class="primary-button" @click="handleCancel">继续使用</button>
      </div>
    </div>
  </div>
</template>
